var e=(e,t)=>()=>(e&&(t=e(e=0)),t),t=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports);(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var n=e((()=>{})),r,i=e((()=>{r={en:{flag:`🇺🇸`,label:`EN`,full:`English`,pageTitle:`Dhaboav's Website`,navbar:{home:`Home`,about:`About`,projects:`Projects`,blog:`Blog`,contact:`Let's talk`},hero:{greet:`Hi, I'm`,tagline:`Passionate about robotics and computer vision, developing smart systems that see and act.`,viewWork:`View work`,resume:`Resume`,resumeFile:`resume`},about:{label:`About`,title:`Building with purpose`,p1:`I'm passionate about robotics and computer vision. Building systems that see, interpret, and respond to the world around them. I believe in keeping things simple, robust, and meaningful.`,p2:`When I'm not writing code, you'll probably find me reading a good book, grinding through a game, or binge-watching anime.`,techLabel:`Tech Stack`},projects:{title:`Selected work`,label:`Projects`,repo:`Repository`},experience:{title:`Experience`},blog:{label:`Blog`,title:`Technical Notes`,allButton:`See all`,description:`Thoughts on the future of robotics, AI ethics, and the technical challenges of computer vision in Indonesia.`,blogLinkButton:`Read more`},contact:{label:`Contact`,title:`Let's connect`,subtitle:`Have a project in mind or just want to chat? I'd love to hear from you.`,namePlaceholder:`Name`,emailPlaceholder:`Email`,messagePlaceholder:`Message`,send:`Send message`,loading:`Sending...`,success:`Message sent successfully!`,failure:`Failed to send message.`}},id:{flag:`🇮🇩`,label:`ID`,full:`Indonesia`,pageTitle:`Website Dhaboav`,navbar:{home:`Beranda`,about:`Tentang`,projects:`Proyek`,blog:`Blog`,contact:`Mari terhubung`},hero:{greet:`Hai, saya`,tagline:`Berfokus pada robotika dan computer vision, mengembangkan sistem pintar yang dapat melihat dan bertindak.`,viewWork:`Lihat karya`,resume:`resume`,resumeFile:`resume-id`},about:{label:`Tentang`,title:`Membangun dengan tujuan`,p1:`Saya tertarik pada robotika dan computer vision. Membangun sistem yang dapat melihat, memahami, dan merespons dunia di sekitarnya.`,p2:`Saat tidak ngoding, saya biasanya membaca buku, bermain game, atau menonton anime.`,techLabel:`Tumpukan Teknologi`},projects:{title:`Karya pilihan`,label:`Proyek`,repo:`Repositori`},experience:{title:`Pengalaman`},blog:{label:`Blog`,title:`Catatan Teknis`,allButton:`Lihat semua`,description:`Pemikiran tentang masa depan robotika, etika AI, dan tantangan teknis computer vision di Indonesia.`,blogLinkButton:`Baca selengkapnya`},contact:{label:`Kontak`,title:`Terhubung`,subtitle:`Punya proyek atau sekadar ingin berbicara? Saya siap mendengarkan.`,namePlaceholder:`Nama`,emailPlaceholder:`Email`,messagePlaceholder:`Pesan`,send:`Kirim pesan`,loading:`Mengirim...`,success:`Pesan berhasil dikirim!`,failure:`Gagal mengirim pesan.`}},jp:{flag:`🇯🇵`,label:`JP`,full:`日本語`,pageTitle:`Dhaboavのウェブサイト`,navbar:{home:`ホーム`,about:`概要`,projects:`プロジェクト`,blog:`ブログ`,contact:`話しましょう`},hero:{greet:`こんにちは、私は`,tagline:`ロボティクスとコンピュータビジョンに情熱を持ち、見て判断し行動するスマートシステムを開発しています。`,viewWork:`作品を見る`,resume:`履歴書`,resumeFile:`resume`},about:{label:`概要`,title:`目的を持って作る`,p1:`私はロボット工学とコンピュータビジョンに情熱があります。世界を見て理解し反応するシステムを作ることを追求しています。`,p2:`コードを書いていないときは、本を読んだりゲームをしたりアニメを見ています。`,techLabel:`技術スタック`},projects:{title:`選ばれた作品`,label:`プロジェクト`,repo:`リポジトリ`},experience:{title:`経験`},blog:{label:`ブログ`,title:`技術ノート`,allButton:`すべてを見る`,description:`ロボティクス、AI倫理、およびインドネシアにおけるコンピュータビジョンの技術的課題についての考察。`,blogLinkButton:`続きを読む`},contact:{label:`連絡先`,title:`つながりましょう`,subtitle:`相談やお話があれば、ぜひご連絡ください。`,namePlaceholder:`名前`,emailPlaceholder:`メールアドレス`,messagePlaceholder:`メッセージ`,send:`送信`,loading:`送信中...`,success:`メッセージが正常に送信されました！`,failure:`メッセージの送信に失敗しました。`}}}}));function a(){return localStorage.getItem(`site-lang`)||`en`}function o(){let e=a();document.documentElement.lang=e,document.title=r[e].title||`Dhaboav's Website`}function s(e){return r[a()][e]||{}}var c=e((()=>{i()}));function l(){let e=s(`navbar`),t=document.createElement(`header`);t.className=`
        ...
        <div class="container mx-auto max-w-7xl px-4 sm:px-6">
            <nav class="flex h-16 items-center justify-between">
                ...
                <div class="hidden sm:flex items-center gap-8">
                    ...
                    <a href="#blog" class="link-underline text-sm text-zinc-400 hover:text-white">${e.blog}</a>
                </div>
            ...
            <div id="mobile-menu"
                ...
                <a href="#blog" class="text-sm hover:text-white">${e.blog}</a>
                ...
                <div class="w-full px-4 mb-12 lg:mb-0 lg:w-1/2">
                    ...
                    <a href="other/${e.resumeFile}.pdf" 
                          ...
                          class="inline-flex items-center justify-center gap-1 text-sm text-zinc-400 transition-colors hover:text-white leading-none border-1 border-white/20 hover:bg-primary hover:border-primary p-2 rounded-lg">
                            ...
                            <span class="leading-none">${e.resume}</span>
                        </a>
    ...
    `,i}function y(){let e=a(),t=s(`about`),n=s(`experience`),r=document.createElement(`section`);r.id=`about`,r.className=`min-h-screen bg-zinc-900 py-32 md:py-40 lg:py-56`,r.innerHTML=`
        <div class="container mx-auto max-w-7xl px-4 sm:px-6">
    ...
    `,a}function w(){let e=a(),t=s(`projects`),n=document.createElement(`section`);n.id=`projects`,n.className=`min-h-screen bg-black py-32 md:py-40 lg:py-56`,n.innerHTML=`
        <div class="container mx-auto max-w-7xl px-4 sm:px-6">
    ...
    `;let r=n.querySelector(`.projects-list`);return x.forEach(n=>{let{image:i,link:a}=n,{title:o,description:s}=n.text[e];r.appendChild(C({title:o,description:s,image:i,link:a,repo:t.repo}))}),n}var T=e((()=>{S(),c()})),E,D=e((()=>{E=[{date:`MAR 2025`,dateISO:`2025-03-15`,text:{id:{tag:`Computer Vision`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},en:{tag:`Computer Vision`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},jp:{tag:`コンピュータビジョン`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`}}},{date:`FEB 2025`,dateISO:`2025-02-15`,text:{id:{tag:`Robotika`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},en:{tag:`Robotics`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},jp:{tag:`ロボティクス`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`}}},{date:`Des 2025`,dateISO:`2025-12-15`,text:{id:{tag:`Robotika`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},en:{tag:`Robotics`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},jp:{tag:`ロボティクス`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`}}},{date:`MAR 2024`,dateISO:`2024-03-15`,text:{id:{tag:`Computer Vision`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},en:{tag:`Computer Vision`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},jp:{tag:`コンピュータビジョン`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`}}},{date:`FEB 2025`,dateISO:`2025-02-15`,text:{id:{tag:`Robotika`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},en:{tag:`Robotics`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},jp:{tag:`ロボティクス`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`}}},{date:`Jan 2026`,dateISO:`2026-01-22`,text:{id:{tag:`Robotika`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},en:{tag:`Robotics`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`},jp:{tag:`ロボティクス`,title:`loresipsum dolor sit amet consectetur adipisicing elit`,excerpt:`Loresipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`}}}]}));function O({date:e,tag:t,title:n,excerpt:r,linkButton:i}){let a=document.createElement(`article`);return a.className=`bg-foreground p-8 hover:bg-foreground/95 transition-colors group cursor-pointer flex flex-col`,a.innerHTML=`
    ...
    <p class="text-sm opacity-70 mb-8 flex-1 text-background">${r}</p>
  ...
  `,a}function k(){let e=a(),t=s(`blog`),n=t.title.split(` `),r=document.createElement(`section`);r.id=`blog`,r.className=`min-h-screen py-32 md:py-40 lg:py-56 bg-foreground text-background`,r.innerHTML=`
    <div class="container mx-auto max-w-7xl px-4 sm:px-6">
      <div class="flex flex-col md:flex-row justify-between mb-20 gap-8">
        <div>
          ...
          <h2 class="text-5xl md:text-7xl font-display font-extrabold uppercase tracking-tighter leading-[0.9] text-background">
            ${n[0]}<br />
            <span class="font-serif italic font-normal normal-case">${n[1]}</span>
          </h2>
        </div>
  ...
  `;let i=r.querySelector(`.blog-list-container`);return[...E].sort((e,t)=>new Date(t.dateISO)-new Date(e.dateISO)).slice(0,3).forEach(n=>{let{title:r,excerpt:a,tag:o}=n.text[e],s=O({date:n.date,tag:o,title:r,excerpt:a,linkButton:t.blogLinkButton});i.appendChild(s)}),r}var A=e((()=>{D(),c()}));function j(){let e=s(`contact`),t=document.createElement(`section`);t.id=`contact`,t.className=`bg-black text-white min-h-screen bg-black py-32 md:py-40 lg:py-56`,t.innerHTML=`
