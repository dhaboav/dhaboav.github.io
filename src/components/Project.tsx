    ...
    <section id="projects" className="min-h-screen bg-black py-32">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="mb-2">
          ...
          <h2 className="text-3xl font-medium tracking-tight text-white">{textLang.title}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          {projectsData.map((project, index) => {
            ...
            return (
              <div
                key={`${link}-${index}`}
                className="flex h-full flex-col overflow-hidden rounded-xl border-1 border-white/30"
              >
                ...
                <div className="flex flex-1 flex-col justify-between p-5">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="border-primary hover:bg-primary block w-full rounded-md border-1 py-2 text-center text-xs font-medium text-white transition-colors"
                  >
                    {textLang.repo}
                  </a>
                </div>
