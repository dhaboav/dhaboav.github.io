import type { WebUiTranslations } from '@/types/ui-translations';
...
export const id: WebUiTranslations = {
  ...
  projects: {
    projectLabel: 'Proyek',
    projectHeader: 'Proyek pilihan',
    gitHubRepoLabel: 'Repositori',
  },
  blog: {
    blogLabel: 'Blog',
    blogHeader: {
  ...
  contact: {
    ...
    loadingStatus: 'Mengirim...',
    successStatus: 'Pesan berhasil dikirim!',
    failureStatus: 'Gagal mengirim pesan.',
  },
};
